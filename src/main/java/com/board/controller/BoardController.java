...
public class BoardController extends UiUtils {
	...
	public String registerBoard(@ModelAttribute("params") final BoardDTO params, Model model) {
		...
		try {
			...
			if (isRegistered == false) {
				return showMessageWithRedirect("Failed to Register", "/board/list.do", Method.GET, pagingParams, model);
			}
	...
	public String openBoardDetail(@ModelAttribute("params") BoardDTO params, @RequestParam(value = "idx", required = false) Long idx,
			Model model) {
		if (idx == null) {
